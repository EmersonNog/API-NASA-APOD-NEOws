const apiKey = "KhhupsLvTS5PZtWMfvBZSbg8YBN148hgydVbbh25";
    ...
    .then(data=>{
        ...
        apodElement.innerHTML = (`
            ...
            <div class="card-action">
                <a href="https://www.nasa.gov">More Information</a>
            </div>
        `)
    }).catch(handleError);

    const element = document.querySelectorAll('.datepicker');
    const instances = M.Datepicker.init(element, {
        autoClose: true,
        format: 'yyyy-mm-dd',
